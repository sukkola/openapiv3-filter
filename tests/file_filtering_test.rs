...
#[test]
fn it_filters_yaml_files() -> Result<(), Box<dyn Error>> {
...
#[test]
fn it_filters_json_files() -> Result<(), Box<dyn Error>> {
...
#[test]
fn it_reports_parsing_errors() -> Result<(), Box<dyn Error>> {
...
#[test]
fn it_reports_io_errors() -> Result<(), Box<dyn Error>> {
...
#[test]
fn it_handled_piped_input_with_explicit_pipe_marker_yaml() -> Result<(), Box<dyn Error>> {
...
#[test]
fn it_handled_piped_input_without_explicit_pipe_marker_yaml() -> Result<(), Box<dyn Error>> {
...
#[test]
fn it_handled_piped_input_without_explicit_pipe_marker_without_filtering_yaml() -> Result<(), Box<dyn Error>> {
...
#[test]
fn it_handled_piped_input_without_explicit_pipe_marker_without_filtering_json() -> Result<(), Box<dyn Error>> {
